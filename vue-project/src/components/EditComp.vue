...
export default {
  ...
  methods: {
    ...
    async putInfo() {
      ...
      try {
        await axios.put("/update-string/text", {
          form: this.form,
          id: this.id,
        });
      } catch (error) {
      ...
      try {
        await axios.put("/update-string/file ", this.formdata, {
          headers: {
      ...
      <form>
        ...
        <div class="mb-3">
          ...
          <div>
            ...
            <a
              :href="this.form.Research"
              class="download-link"
              v-if="this.form.Research"
              >Скачать</a
            >
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div>
            ...
            <a
              :href="this.form.DrugVideo"
              class="download-link"
              v-if="this.form.DrugVideo"
              >Скачать</a
            >
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div>
            ...
            <a
              :href="this.form.GistolConclusion"
              class="download-link"
              v-if="this.form.GistolConclusion"
              >Скачать</a
            >
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div>
            ...
            <a
              :href="this.form.MrtDisk"
              class="download-link"
              v-if="this.form.MrtDisk"
              >Скачать</a
            >
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div>
            ...
            <a
              :href="this.form.CktModel"
              class="download-link"
              v-if="this.form.CktModel"
              >Скачать</a
            >
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div>
            ...
            <a
              :href="this.form.MrtModel"
              class="download-link"
              v-if="this.form.MrtModel"
              >Скачать</a
            >
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <div>
            ...
            <a
              :href="this.form.OperationVideo"
              class="download-link"
              v-if="this.form.OperationVideo"
              >Скачать</a
            >
          </div>
        </div>
